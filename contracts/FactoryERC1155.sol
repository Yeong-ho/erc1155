...
contract FactoryERC1155{
    ...
    */
    ...
    function getTransferForm(uint _index, uint _id, address fromaddress, address toaddress, uint256 amount) public{
        ERC1155Token token = tokens[_index];
        token.safeTransferFrom(fromaddress, toaddress, _id, amount,'');
    }
